...
{
    public partial class frmFindProductInventoryDepartment : XtraForm
    {
        public frmFindProductInventoryDepartment()
        {
            InitializeComponent();
        ...
        void ShowData()
        {
            gridControl.DataSource = lgInventory.Show_ListInventoryImportDepartment(Date);
            try
            {
        ...
        string productCode, productName, productDetail, productManufacturer, productCountry, productID, productUnit,  lotID, lotNumber, depotID, depotName;
        ...
        private void frmFindProduct_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                if (productID != null)
                {
                    this.sender(productID, productCode, productName, productDetail, productManufacturer, productCountry, productUnit, null,lotID, lotNumber, depotID, depotName);
                    this.Close();
                }
