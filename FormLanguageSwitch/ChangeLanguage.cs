...
namespace FormLanguageSwitch
{
    public class FormLanguage
    {
        ...
        /// </summary>
        protected static readonly FormLanguage m_instance = new FormLanguage();
        ...
        /// </summary>
        public static FormLanguage Instance
        {
        ...
        private void ReloadTreeViewNodes(System.Windows.Forms.TreeView treeView, System.Resources.ResourceManager resources)
        {
            if (treeView.Nodes.Count > 0)
            {
                ...
                System.Diagnostics.Debug.Assert(newNodes[0] != null);
